...
class RobotGazeboEnv(gym.Env):
    ...
    def __init__(self, robot_name_space, controllers_list, reset_controls, start_init_physics_parameters=True, reset_world_or_sim="SIMULATION"):
        ...
        self.gazebo_world_launch_name = self._get_gazebo_world_launch_name()
        self.episode_num = 0
    ...
    def get_gazebo_world_launch_name(self):
        return self.gazebo_world_launch_name
    ...
    def _publish_reward_topic(self, reward, step, episode_number=1):
        """
